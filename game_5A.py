...
def load_game(player_start):
    ...
    try:
        ...
        # Read each line into variable
        player_start[FLEW] = infile.readline()
        player_start[BEHIND] = infile.readline()
        player_start[MAGIC] = infile.readline()
        player_start[SPELLS] = infile.readline()

        # Code I'm referencing would go here
